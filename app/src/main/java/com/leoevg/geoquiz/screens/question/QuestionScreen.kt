        ...
        Row (
            ...
            Row (
                ...
                Icon(
                    ...
                    modifier = Modifier.clickable { viewModel.onEvent(QuestionScreenEvent.SilentModeBtnClicked) }
                )
                Icon(
                    painter = painterResource(R.drawable.play_button),
                    contentDescription = "play_icon_button",
                    modifier = Modifier.clickable { viewModel.onEvent(QuestionScreenEvent.NightModeBtnClicked) }
                )
            }
        }
        AsyncImage(
        ...
        Column (
            ...
            Row (
                ...
                Button(
                    ...
                    contentPadding = PaddingValues(vertical = 15.dp),
                    shape = RoundedCornerShape(25.dp),
                    onClick = { viewModel.onEvent(QuestionScreenEvent.ApplyBtnClicked) }
                ) {
                    Icon(
